...
import arie.footballclubapi.R.id.team_badge
import arie.footballclubapi.R.id.team_name
...
class FavoriteTeamsAdapter(private val favorite: List<Favorite>, private val listener: (Favorite) -> Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteViewHolder {
        return FavoriteViewHolder(TeamFavUI().createView(AnkoContext.create(parent.context, parent)))
    }
